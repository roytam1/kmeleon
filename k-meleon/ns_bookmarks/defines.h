...
#define PREFERENCE_EDIT_ZOOM _T("kmeleon.plugins.bookmarks.editdialog.zoom")
#define PREFERENCE_EDIT_MAX _T("kmeleon.plugins.bookmarks.editdialog.maximized")
#define PREFERENCE_SETTINGS_DIR    "kmeleon.general.settingsDir"
#define PREFERENCE_BOOKMARKS_OPENURL _T("kmeleon.plugins.bookmarks.openurl")
