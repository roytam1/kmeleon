...
var gMainPane = {
  ...
  readUseSaveDir: function ()
  {
    var downloadFolder = document.getElementById("saveFolder");
    var chooseFolder = document.getElementById("chooseSaveFolder");
    var preference = document.getElementById("kmeleon.download.useSaveDir");
    downloadFolder.disabled = !preference.value;
    chooseFolder.disabled = !preference.value;    
  ...
  {
    return this._chooseFolder("browser.download.dir", "browser.download.folderList");
  },
  
  chooseSaveFolder: function () 
  {
    return this._chooseFolder("kmeleon.download.saveDir", "kmeleon.download.saveFolderList");
  },
   ...
   */
  _chooseFolder: function (pref, fpref)
  {
    ...
    let folderListPref = document.getElementById(fpref);
    let currentDirPref = this._indexToFolder(folderListPref.value, pref); // file
    ...
    let fpCallback = function fpCallback_done(aResult) {
      if (aResult == nsIFilePicker.returnOK) {
        ...
        let downloadDirPref = document.getElementById(pref);
  ...
  displaySaveDirPref: function ()
  {
    return this.displayDownloadDirPref("saveFolder", "kmeleon.download.saveDir", "kmeleon.download.saveFolderList");
  },
  /**
   * Initializes the download folder display settings based on the user's
   * preferences.
   */
  displayDownloadDirPref: function (id, pref, fpref)
  {
    if (!pref) pref = "browser.download.dir";
    if (!fpref) fpref = "browser.download.folderList";
    if (!id) id = "downloadFolder";
    var folderListPref = document.getElementById(fpref);
    var bundlePreferences = document.getElementById("bundlePreferences");
    var downloadFolder = document.getElementById(id);
    var currentDirPref = document.getElementById(pref);
    ...
    if (folderListPref.value == 2) {
      ...
      try {iconUrlSpec = fph.getURLSpecFromFile(currentDirPref.value);} catch(e) {};
   ...
   */
  _indexToFolder: function (aIndex, pref)
  {
    switch (aIndex) {
      case 0:
  ...
  {
    return this._getFolderListPref("browser.download.dir", "browser.download.folderList");
  },
  
  getSaveFolderListPref: function ()
  {
    return this._getFolderListPref("kmeleon.download.saveDir", "kmeleon.download.saveFolderList");
  },
  /**
   * Returns the value for the browser.download.folderList preference.
   */
  _getFolderListPref: function (pref, fpref)
  {
    var folderListPref = document.getElementById(fpref);
